...
training_args = TrainingArguments(
    output_dir="train_beit_large16_512_22k_25_test",
...
trainer.save_model("./model_beit_large16_512_22k_25")


log_history = trainer.state.log_history
with open('./model_beit_large16_512_22k_25/log_history.json', 'w') as file:
